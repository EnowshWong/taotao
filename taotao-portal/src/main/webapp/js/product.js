...
function strtotime(t, e) {
    ...
    function s(t) {
        var e = t.split(" "), s = e[0], a = e[1].substring(0, 3), n = /\d+/.test(s), o = "ago" === e[2],
            c = ("last" === s ? -1 : 1) * (o ? -1 : 1);
    ...
    if (r = e ? new Date(1e3 * e) : new Date, c = {
        sun: 0,
        mon: 1,
        tue: 2,
        wed: 3,
        ...
        min: "Minutes",
        sec: "Seconds"
    }, p = "(years?|months?|weeks?|days?|hours?|minutes?|min|seconds?|sec|sunday|sun\\.?|monday|mon\\.?|tuesday|tue\\.?|wednesday|wed\\.?|thursday|thu\\.?|friday|fri\\.?|saturday|sat\\.?)", m = "([+-]?\\d+\\s" + p + "|" + "(last|next)\\s" + p + ")(\\sago)?", n = t.match(RegExp(m, "gi")), !n)
        return !1;
...
function monthDay(t, e) {
    var i, s, a, n = new Date(1e3 * t), o = new Date(1e3 * e), r = n.getFullYear(), c = n.getMonth() + 1,
        l = n.getDate(), d = o.getFullYear(), p = o.getMonth() + 1, m = o.getDate(), u = "", h = 12 * (d - r) + p - c;
...
function el_top_middle(t, e, i) {
    ...
    var o = n.docHeight() != n.clientHeight() ? 16 : 0, r = $(document).scrollTop(), c = (n.clientHeight() - a) / 2 + r,
        l = (n.clientWidth() - o - s) / 2;
    t.css({left: l, top: c})
}
...
function setSearch(t, e) {
    ...
    $.ajax({
        url: "http://api.search.jd.com/?key=" + s + "&pagesize=" + i + "&filt_type=wyn,L1M1;wstate,L1M1" + e,
        dataType: "jsonp",
        success: function (t) {
            var e = t.Summary.key;
...
function seoBanner(t, e) {
    $.ajax({
        url: "http://seo.jd.com/adrpc/source.action",
        data: {cateid: G.cat[0], type: 5, ison: 1 === warestatus ? !0 : !1},
        dataType: "jsonp",
        success: function (t) {
...
function getSuitInfoService(t) {
    if (null !== t.packResponseList && t.packResponseList.length > 0) {
        ...
        $("#favorable-suit").show(), $("#favorable-suit .mc").html(suit_TPL.tabs.process(t) + suit_TPL.cons.process(t)), $("#favorable-suit .mc").Jtab({
            event: e >= t.packResponseList.length ? "mouseover" : "click",
            delay: 300,
            compatible: !0,
            currClass: "scurr"
        }, function (t, e) {
            var i = e.attr("packprice"), s = e.attr("data-cat"), a = e.attr("packlistprice"), n = e.attr("discount"),
                o = e.find(".fitting-price"), r = e.find(".orign-price"), c = e.find(".fitting-saving"),
                l = e.find(".infos .p-name a,.infos .btns a"), d = [G.sku];
...
function onlineService(t, e, i) {
    ...
    var v = "http://" + i + "/index.action?", b = {
        ...
        recent: f,
        code: t,
        area: s($("#store-selector .text").text()),
        size: s($("#choose-version .dd .selected a").text()),
        services: s($("#summary-service .dd").html())
    };
...
function log(t, e) {
    ...
    var a = decodeURIComponent(escape(getCookie("pin"))),
        n = "http://csc.360buy.com/log.ashx?type1=$type1$&type2=$type2$&data=$data$&pin=$pin$&referrer=$referrer$&jinfo=$jinfo$&callback=?",
        o = n.replace(/\$type1\$/, escape(t));
    ...
    var r = ("https:" == document.location.protocol ? "https://mercuryssl" : "http://mercury") + ".jd.com/log.gif" + "?t=other.000000" + "&m=UA-J2011-1" + "&v=" + encodeURIComponent("t1=" + t + "$t2=" + e + "$p0=" + s) + "&ref=" + encodeURIComponent(document.referrer) + "&rm=" + (new Date).getTime(),
        c = new Image(1, 1);
    c.src = r
}
...
function CombineShare(t) {
    this.$el = t.$el, this.imgs = "string" == typeof t.imgs ? [t.imgs] : t.imgs, this.onbeforeOpen = t.onbeforeOpen || function () {
    }, t.title.length > 27 && (t.title = t.title.substr(0, 27) + "..."), this.shareParam = {
        sid: t.sid,
        rid: t.rid,
        title: t.title,
        content: t.content,
        ...
        T2: {
            name: "sina",
            text: "\u65b0\u6d6a\u5fae\u535a",
            url: "http://share.jd.com/sina/login.action"
        },
        T3: {name: "qqWeibo", text: "\u817e\u8baf\u5fae\u535a", url: "http://share.jd.com/qqweibo/login.action"},
        T4: {name: "renren", text: "\u4eba\u4eba\u7f51", url: "http://share.jd.com/renren/login.action"},
        T5: {name: "kaixin", text: "\u5f00\u5fc3\u7f51", url: "http://share.jd.com/kaixin001/login.action"},
        T6: {name: "douban", text: "\u8c46\u74e3\u7f51", url: "http://share.jd.com/douban/login.action"}
    }, this.init()
}
...
(function (t) {
    "object" == typeof pageConfig.product && (t.sku = pageConfig.product.skuid, t.key = pageConfig.product.skuidkey, t.url = pageConfig.product.href, t.src = pageConfig.product.src, t.name = pageConfig.product.name, t.mdPerfix = 1 == pageConfig.product.type ? "CR" : "GR", t.mbPerfix = 1 == pageConfig.product.type ? "3C" : "GM", t.mp = pageConfig.product.mp, t.jp = pageConfig.product.jp, t.cat = pageConfig.product.cat, t.orginSku = pageConfig.product.orginSkuid || t.sku, t.isJd = 1e9 > t.sku, t.isPop = t.sku > 1e9, t.isCellphone = 655 == pageConfig.product.cat[2] || 6881 == pageConfig.product.cat[2] || 6882 == pageConfig.product.cat[2], t.isArray = function (t) {
        ...
        if (null !== e && (n = readCookie("ipLoc-djd") ? "&area=" + readCookie("ipLoc-djd").replace(/-/g, "_") : "&area=1"), void 0 !== t) {
            ...
            $.ajax({
                url: o, dataType: "jsonp", success: function (t) {
                    if (!t && !t.length)
                        return !1;
        ...
        var e, i, s, a, n = t.indexOf("?"), o = t.substr(0, n), r = t.substr(n + 1), c = r.split("&"), l = c.length,
            d = {};
        for (e = 0; l > e; e++)
        ...
        e.find(".p-scroll").each(function () {
            var t = $(this).find(".p-scroll-wrap"), e = $(this).find(".p-scroll-next"),
...
//        , $.ajax({url: "http://club.jd.com/ProductPageService.aspx?method=GetCommentSummaryBySkuId&referenceId=" + t + "&callback=getCommentCount",dataType: "script",cache: !0})
        ...
        t = t || [], e = e || $("body").eq(0), i = i || "p-comm-", s = s || "(\u5df2\u6709{NUM}\u4eba\u8bc4\u4ef7)", $.ajax({
        ...
        var s = $(i), a = e, n = s.find(".suits"), o = s.find(".stab li"), r = s.find(".suits .lh"),
            c = n.find('li[data-cat="' + a + '"]');
        if ("all" == e) {
        ...
        var a = {
            t: t.id || (1 == pageConfig.product.type ? "rec.993003" : "rec.993001"),
            v: s,
            m: t.m || "UA-J2011-1",
            ref: t.ref || document.referrer,
            random: t.random || Math.random()
        };
        ...
        var e = "", i = RegExp("-" + t + "-"), s = "-27-28-31-32-67-68-69-70-78-79-42-64-65-66-71-72-73-74-80-81-",
            a = "-2-3-4-44-49-", n = "-6-7-41-47-", o = "-9-48-60-", r = "-15-16-17-18-45-46-61-63-", s = "-11-",
            c = "-52-53-54-57-58-59-75-82-83-84-";
        ...
        var n = new Image,
            o = "http://mercury.jd.com/log.gif?t=rec." + t + "&v=" + encodeURIComponent("src=rec$action=" + e + "$enb=1$sku=" + i + "$csku=" + s + "$index=" + (a || 0) + "$expid=0") + "&m=UA-J2011-1&ref=" + encodeURIComponent(document.referrer) + "&random=" + Math.random();
        ...
        init: function (t, e) {
            ...
            var e = Math.floor(t / 86400), i = Math.floor(t % 86400 / 3600), s = Math.floor(t % 86400 % 3600 / 60),
                t = t % 86400 % 3600 % 60;
...
//        }), this
    ...
    var e = function (e, i) {
        this.opts = t.extend({
            start: null, end: null, startThrehold: 0, stopThrehold: 0, onStart: function () {
            }, onEnd: function () {
            }, onScroll: function () {
            }
    ...
    e.prototype = {
        init: function () {
            ...
            var e = t(document).scrollTop(), i = this.opts.start || this.$o.offset().top,
                s = this.opts.end || i + this.$o.outerHeight(), a = t(window).height();
    ...
    var e = function (e, i, s) {
        this.opts = t.extend({
            ...
            close: !1,
            autoClose: !1
        }, i), this.$obj = t(e), this.callback = s || function () {
        }, this.init()
    };
    e.prototype = {
        init: function () {
            ...
            var e = document, i = e.getElementsByTagName("head"), s = e.createElement("style"),
            ...
            if (t.css({
                ...
                top: i.oTop - 10 + this.opts.oTop,
                left: i.oLeft - this.tips.outerWidth() - this.opts.oLeft
            }), "right" === e && t.css({
                left: i.oLeft + i.w + this.opts.oLeft,
                top: i.oTop - 10 + this.opts.oTop
            }), "top" === e && t.css({
                left: i.oLeft - 10 + this.opts.oLeft,
                top: i.oTop - this.tips.outerHeight() - this.opts.oTop
            }), "bottom" === e && t.css({
                left: i.oLeft - 10 + this.opts.oLeft,
                top: i.oTop + i.h + this.opts.oTop
            }), this.opts.autoClose) {
                var s = this.$obj.css("position");
                this.$obj.css({position: "static" == s ? "relative" : s}), t.css({
                    left: this.opts.oLeft,
                    top: this.$obj.outerHeight()
                })
            }
        }, setTips: function () {
            var e = this.opts.close ? '<div class="Jtips-close">&times;</div>' : "",
                i = t('<div data-tipID="' + this.id + '" class="Jtips Jtips-' + this.opts.position + '"><div class="Jtips-arr"></div>' + e + '<div class="Jtips-con">' + this.opts.content + "</div></div>"),
                s = this;
    ...
    t.fn.jqueryzoom = function (e) {
        ...
        t(this).hover(function () {
            ...
            var a = t(this).offset().left, n = t(this).offset().top, o = t(this).find("img").get(0).offsetWidth,
            ...
            t(this).find("img").attr("alt", ""), 0 == t("div.zoomdiv").get().length && (t(this).after("<div class='zoomdiv'><img class='bigimg' src='" + c + "'/></div>"), t(this).append("<div class='jqZoomPup'>&nbsp;</div>")), t("div.zoomdiv").width(i.xzoom), t("div.zoomdiv").height(i.yzoom), t("div.zoomdiv").show(), i.lens || t(this).css("cursor", "crosshair"), t(document.body).mousemove(function (s) {
                ...
                xpos = mouse.x - t("div.jqZoomPup").width() / 2 - a, ypos = mouse.y - t("div.jqZoomPup").height() / 2 - n, i.lens && (xpos = a > mouse.x - t("div.jqZoomPup").width() / 2 ? 0 : mouse.x + t("div.jqZoomPup").width() / 2 > o + a ? o - t("div.jqZoomPup").width() - 2 : xpos, ypos = n > mouse.y - t("div.jqZoomPup").height() / 2 ? 0 : mouse.y + t("div.jqZoomPup").height() / 2 > r + n ? r - t("div.jqZoomPup").height() - 2 : ypos), i.lens && t("div.jqZoomPup").css({
                    top: ypos,
                    left: xpos
                }), scrolly = ypos, t("div.zoomdiv").get(0).scrollTop = scrolly * d, scrollx = xpos, t("div.zoomdiv").get(0).scrollLeft = scrollx * p
            })
        }, function () {
...
var suit_TPL = {
        tabs: '<ul class="stab lh">{for item in packResponseList}<li class="fore${parseInt(item_index)+1}{if item_index==0} scurr{/if}" data-widget="tab-item" data-cat="${item.packId}" data-suit="${item.packName}" title="${item.packName}">{if G.cat[2]==694}${item.packName.substr(0, 6)}{else}\u4f18\u60e0\u5957\u88c5${parseInt(item_index)+1}{/if}</li>{/for}</ul>',
...
//            }})
        ...
        if (pageConfig.product.GrecommendSkus = [], t.success && t.data && t.data.length > 0) {
            ...
            if (902011 === this.rid) {
                ...
                t.json = e(t.data, o), this.el.html(itemDisabled.process(t)), this.el.parents(".clearfix").eq(0).attr("data-widget", "tabs").Jtab({
                    compatible: !0,
                    auto: !0
                })
            }
            if (902018 === this.rid) {
                ...
                a.imgScroll({
                    ...
                    next: "#noitem-backward",
                    disableClass: "disabled"
                }), G.getCommentData(pageConfig.product.GrecommendSkus, a, null)
            }
        ...
        function e(t) {
            if (t) {
                var e = $("#pop-box .p-scroll-wrap"), i = $("#pop-box .p-scroll-next"),
        ...
        var s = $("#tab-hot"), a = {
            ...
            var i = $("#p-scroll .p-scroll-wrap a"), s = $("#pop-list-" + t).find(".p-img img"),
            ...
            sClick: function (t, e) {
                ...
                i.click(function () {
                    var t = $(this).attr("data-resku"), e = $("#p-scroll .p-scroll-wrap .curr").attr("title"),
                        n = $(this).attr("title"), o = $(this).attr("wmaprice"), r = $(this).attr("wmeprice");
                ...
                $("#pop-list-" + i).find(".no-scroll").length > 0 && (o = {
                    ...
                    url: "http://prs.jd.com/Pop/CodeServiceSize.aspx?callback=fetchJSON_sizeList",
                    dataType: "script",
                    cache: !0,
                    data: o
                })
            ...
            $("#p-selected-ok").unbind("click").bind("click", function () {
                ...
                if (e.find("#p-scroll .curr").attr("title"), 1 > $("#pop-box .curr").length)
                    ...
                    var i = $("#pop-list-" + t), s = i.attr("data-res").split("|"), n = s[0], o = s[3], l = s[4],
                        d = i.find(".p-price img");
                    d.attr("src"), i.find("input:checkbox").attr({
                        skuid: n,
                        wmaprice: o,
                        wmeprice: l,
                        checked: !0
...
//            }}) : 6728 == G.cat[0] && G.isJd ? $.ajax({url: "http://misc.360buyimg.com/product/js/2012/fittingsAuto.js?ver=20140424",dataType: "script",cache: !0}) : $.getJSONP("http://d.360buy.com/fittingInfo/get?skuId=" + t + "&callback=Recommend.cbRecoFittings"), void 0)
        ...
        if (pageConfig.product.cbNewFittings = [pageConfig.product.skuid], pageConfig.setFittingsClk = function (t, e, i, s, a) {
            ...
            $("#newFittign-tab").prepend(s.tabs.process(t)).Jtab({
                event: "click",
                compatible: !0,
                currClass: "scurr"
            }, function (t, i, a) {
                var n = $("#newFittign-tab .suits"), o = $("#tab-cat-" + a).attr("data-cat").split("|")[1],
                    r = $("#tab-cat-" + a).attr("data-cat").split("|")[0], c = $("#more-fitting-link a");
                if (830 != G.cat[1])
                    if (c.attr("href", "http://rs.jd.com/accessorie/center.html?sku=" + G.sku + "&thirdTypeId=" + o).html("\u8fdb\u5165" + r), n.scrollLeft(0), 0 !== a) {
                        ...
                        window.fetchJSON_fittingExtra = function (t) {
                            ...
                            url: "http://rs.jd.com/accessorie/newServiceList.jsonp?sku=" + G.sku + "&thirdTypeId=" + o + "&callback=fetchJSON_fittingExtra",
                            dataType: "script",
                            cache: "true",
                            scriptCharset: "utf-8"
...
var Refresh = {
    ...
    loadFirstPage: !1, init: function (t) {
        ...
        this.commList.find(".btn-toggle").unbind("click").bind("click", function () {
            ...
            var i = $(e.target), s = i.attr("data-guid"), a = i.attr("data-replyId"), n = i.attr("data-nickname"),
                o = i.parents(".reply-input").find("input").val(), r = {};
            if (i.hasClass("reply-btn"))
                return t.currReply = i, o = o.replace(/</g, "<").replace(/>/g, ">"), a = i.hasClass("reply-btn-lz") ? "" : a, r = {
                    guid: s,
                    content: o,
                    replyId: a,
                    nickname: n
                }, "" === o.replace(/\s+/, "") ? (alert("\u8bf7\u8f93\u5165\u56de\u590d\u5185\u5bb9"), void 0) : (G.checkLogin(function (e) {
        ...
        return "" === t.content.replace(/\s+/, "") ? (alert("\u8bf7\u8f93\u5165\u56de\u590d\u5185\u5bb9"), !1) : 1 > s.length || s.length > 800 ? (alert("\u56de\u590d\u5185\u5bb9\u5e94\u57281~400\u4e2a\u5b57\u4ee5\u5185"), !1) : ($.ajax({
            url: "http://club.jd.com/index.php?", data: i, dataType: "jsonp", success: function (i) {
                1 === i.status ? (i.data.nickname = t.nickname, e.setReplyItem(i.data)) : i.info && alert(i.info)
            }
        }), void 0)
    }, setReplyItem: function (t) {
        var e, i = this, s = i.currReply.parents(".i-item").eq(0), a = s.find(".reply-lz"),
            n = i.currReply.parents(".reply-list").eq(0), o = n.find(".parentReplyFrom"),
            r = this.currReply.parents(".item-reply").eq(0), c = a.next();
        ...
        var a = this;
        this.wrap = t, this.type = e || 0, this.page = i, this.sType = s || 3, this.commRateLoaded = !1, this.url = "http://club.jd.com/productpage/p-{skuId}-s-{commType}-t-{sortType}-p-{currPage}.html", this.url = this.url.replace("{skuId}", this.sku).replace("{commType}", this.type).replace("{sortType}", this.sType).replace("{currPage}", this.page), $.ajax({
    ...
    getData: function (t, e) {
        ...
        $.ajax({
            url: e, dataType: "jsonp", success: function (e) {
    ...
    getData: function (t, e) {
        ...
        $.jmsajax({
            url: "/newsserver.asmx", method: "PayExplain", data: {id: "A-product-0" + (t - 3)}, success: function (i) {
                if (null != i) {
        ...
        $.ajax({
            url: s, dataType: "jsonp", data: {wid: t, keyword: encodeURI(e), page: i, ps: 5}, success: function (t) {
                ...
                if (t.length > 0) {
                    var s = 0 >= t[0].list.length || 0 >= t[0].total ? "\uff0c\u8bd5\u8bd5\u66f4\u7b80\u77ed\u7684\u5173\u952e\u8bcd\u6216\u66f4\u6362\u5173\u952e\u8bcd" : "",
                        n = '<div id="consult-result" class="result clearfix"><div class="fl">\u5171\u641c\u7d22\u5230<strong>' + t[0].total + "</strong>\u6761\u76f8\u5173\u54a8\u8be2" + s + '\u3000<a id="backConsultations" href="#none">\u8fd4\u56de</a></div><div class="fr"><em>\u58f0\u660e\uff1a\u4ee5\u4e0b\u56de\u590d\u4ec5\u5bf9\u63d0\u95ee\u80053\u5929\u5185\u6709\u6548\uff0c\u5176\u4ed6\u7f51\u53cb\u4ec5\u4f9b\u53c2\u8003\uff01</em></div></div>';
    ...
    init: function (t) {
        ...
        $(".wiki-pop dl"), e.each(function () {
            ...
            s.hover(function () {
                var s = $("#product-detail"), a = s.offset().left, n = s.outerWidth(), o = $(this).offset().left,
                    r = o - a > n / 2 ? 310 : 110, c = o - a > n / 2 ? o - 300 : o - 100, l = $(this).offset().top,
                    d = $(this).outerHeight();
                $("#des-" + e).length > 0 && ($("#des-" + e).show().css({
                    left: c,
                    top: l + d - 1
                }), $("#des-" + e).find("b").css({marginLeft: r})), t.t = setTimeout(function () {
                    t.log(i)
                }, 500)
            }, function (e) {
        ...
        var t = this;
        $.ajax({
            url: "http://wiki.jd.com/product/" + G.sku + "/keywords.html", dataType: "jsonp", success: function (e) {
                t.setKeywords(e)
            }
        })
    }
    ...
    init: function (t) {
        ...
        t.vender && t.url && $("#seller dd a").html(t.vender).attr({
            href: t.url,
            title: t.vender
        }), $("#enter-shop a").attr("href", t.url).attr("clstag", "shangpin|keycount|product|pop-01"), t.linkphone && "" == $("#hotline dd").html() && ($("#hotline dd").html(t.linkphone), $("#hotline").show())
    }
}, JdService = {
    init: function (t, e, i) {
        this.sku = t, this.resObj = {}, this.currSku = null, this.obj = e || $("#choose-service .dd"), this.fn = i || function () {
        }, this.url = "", this.typeMap = {
            t2: "ycbs",
            t3: "ycbs",
            t4: "ycbs",
            t6: "ywbh",
...
//            }})
    ...
    init: function (t, e, i) {
        var s, a = this, n = G.serializeUrl(location.href),
            o = /from=weibo/.test(location.href) ? location.search.replace(/\?/, "") : "";
    ...
    setThickBox: function (t, e) {
        var i, s, a, n = {skuId: pageConfig.product.skuid, pin: this._userPin, webSite: 1, origin: 1, source: 1},
            o = G.serializeUrl(location.href);
        /blogPin/.test(location.href) && (n.blogPin = o.param.blogPin), 1 == t && (i = "\u964d\u4ef7\u901a\u77e5", s = this._saleNotify, a = 250), 2 == t && (i = "\u5230\u8d27\u901a\u77e5", s = this._stockNotify, a = 210, n.storeAddressId = readCookie("ipLoc-djd")), s += e ? e : $.param(n), $.jdThickBox({
            type: "iframe",
...
//    e.attr({href: t,"data-origin": encodeURIComponent(t)})
    ...
    var e = [{d: "baidu", q: "wd"}, {d: "google", q: "q"}, {d: "images.google", q: "q"}, {
            d: "images.search.yahoo.com",
            q: "p"
        }, {d: "sogou", q: "query"}, {d: "soso", q: "w"}, {d: "bing", q: "q"}, {d: "youdao", q: "q"}, {
            d: "114so",
            q: "kw"
        }, {d: "zhongsou", q: "w"}, {d: "yisou", q: "q"}, {d: "lycos", q: "query"}, {d: "lycos", q: "word"}, {
            d: "yahoo",
            q: "q"
        }, {d: "yahoo", q: "p"}, {d: "search", q: "q"}, {d: "live", q: "q"}, {d: "aol", q: "query"}, {
            d: "aol",
            q: "encquery"
        }, {d: "aol", q: "q"}, {d: "ask", q: "q"}, {d: "cnn", q: "query"}, {d: "teoma", q: "q"}, {d: "yandex", q: "text"}],
        i = function (t) {
    ...
    init: function () {
        ...
        c = o ? n["T" + t].replace("{IMGWRAP}", n.IMG).replace("{IMGS}", i()) : n["T" + t].replace("{IMGWRAP}", ""), c = c.replace("{LINK}", this.shareParam.url), c = c.replace("{SHARELIST}", r), this.textNumOverflow && (this.shareParam.content = this.cacheText), this.jp && (this.shareParam.content = this.shareParam.content.replace("{PRICE}", this.jp)), c = c.replace("{TEXT}", this.shareParam.content), e !== void 0 && (c = c.replace("{EXT}", e)), jdThickBoxclose && jdThickBoxclose(), 1 === t && $.jdThickBox({
            ...
            height: 100,
            source: c
        }), this.wrap = $("#cb-share" + t), 1 === t && this.updateCount(), this.bindEvent()
    }, bindEvent: function () {
        var t = this, e = this.wrap, i = e.find(".share-btn-ok"), s = e.find(".share-btn-fail,.share-btn-rebind"),
            a = e.find(".share-img-wrap"), n = $("#share-img-prev"), o = $("#share-img-next"), r = a.find("li");
        ...
        var e = t.val(), i = e.replace(/[\u4e00-\u9fa5]/g, "jd").length, s = this.wrap.find(".share-count"),
            a = s.find("em"), n = 100;
        ...
        var t = this;
        $.ajax({
            url: "http://share.jd.com/share/getBindStatus.action", dataType: "jsonp", success: function (e) {
        ...
        var t = this, e = this.wrap.find("dd input:checked"),
            i = this.wrap.find(".share-img-wrap .selected img").attr("src"), s = this.wrap.find("#share-text").val(),
            a = [], n = this.shareParam;
        n.content = s, n.imgUrl = i, e.each(function () {
            var t = $(this).val();
            t && a.push(t)
        }), a.length && (n.type = a.join(","), $.ajax({
            url: "http://share.jd.com/share/shareItem.action", dataType: "jsonp", data: n, success: function (e) {
                var i = [], s = [];
    ...
    var e, i = "http://cart.jd.com/cart/dynamic/gateForSubFlow.action?wids=" + G.sku + "&nums=1&subType=25",
        s = $("#choose-btns"), a = s.find("#choose-btn-easybuy,#choose-btn-divide"), n = s.find("#choose-btn-append"),
        o = $("#nav-minicart"),
        r = '        <div id="choose-btn-baitiao" class="btn">            <a href="#none" class="btn-baitiao" clstag="shangpin|keycount|product|btn-dbt">\u6253\u767d\u6761<b></b></a>        </div>        <div id="choose-btn-baitiao-n" class="btn">            <a href="#none" class="btn-baitiao-n" onclick="showNaBaitiao(\'#Fqfk_Tip\')" clstag="shangpin|keycount|product|btn-dbt">\u62ff\u767d\u6761<b></b></a>        </div>';
    s.prepend(r), e = s.find("#choose-btn-baitiao"), a.remove(), n.hide(), o.addClass("nav-minicart-baitiao"), pageConfig.serviceYB = "disabled", pageConfig.btnBaiTiaoFq = "disabled", o.find("a").attr("href", "#none").addClass("btn-baitiao"), jdModelCallCenter.settings.fn = t, $(".btn-baitiao").click(function () {
        $(this).attr("href", "#none"), pageConfig.product.havestock && $.login({
            modal: !0, complete: function (e) {
    ...
    var t = $("#brand-bar-pop"),
        e = pageConfig.compatible && pageConfig.wideVersion ? "http://img14.360buyimg.com/da/jfs/t400/299/567388192/6321/25ca849/5423c4e8N677e0ae5.png" : "http://img11.360buyimg.com/da/jfs/t337/347/813006143/5018/2539994f/5423c4efNe43efd80.png";
...
//    G.isJd && "enabled" == pageConfig.btnBaiTiaoFq && t.after(e)
    ...
    pageConfig.product.havestock === void 0 ? (s = "", a = "http://cart.gift.jd.com/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = pageConfig.product.havestock ? "" : "disabled", pageConfig.product.havestock ? (s = "", a = "http://cart.gift.jd.com/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = "disabled", a = "#none")), 6980 == G.cat[2] && $('#product-detail [data-widget="tab-item"]').eq(3).hide(), $("#online-service").find("b").html("\u8054\u7cfb\u5ba2\u670d"), $("#comments-list li").eq(4).html('<a href="javascript:;">\u6709\u6652\u5355\u7684\u8bc4\u4ef7<em>(0)</em></a>'), $("body").addClass("cat-1-" + G.cat[0] + " cat-2-" + G.cat[1] + " cat-3-" + G.cat[2] + " item-" + G.sku), G.onAttr("HYKHSP-2", function () {
        ...
        var t = $("#choose-btn-append a"), e = t.attr("href"), i = $("#choose-result .dd"),
            s = $("#choose-result .dd").html(), a = !1;
        ...
        t.mouseover(function () {
            ...
            t.index($(this)), $("#spec-list img").removeClass("img-hover"), e.addClass("img-hover"), $("#spec-n1 img").eq(0).attr({
                src: i.replace("/n5/", "/n1/"),
                jqimg: i.replace("/n5/", "/n0/")
            })
        })
    }(), G.isPop && $.getJSONP("http://st.3.cn/gvi.html?callback=setPopInfo&type=popdeliver&skuid=" + G.sku), CommentListNew.init(G.sku), Recommend.init(pageConfig.product.type), NotifyPop.init("#summary-price .dd a", "#notify-stock", ".btn-notice"), $(".spec-items").imgScroll({
        visible: 5,
        speed: 200,
        step: 1,
        loop: !1,
        ...
        next: "#spec-backward",
        disableClass: "disabled"
    }), $("#recommend").Jtab({event: "click", compatible: !0}), $("#product-detail").Jtab({
        event: "click",
        compatible: !0
    }, function (t, e, i) {
        if ($("#product-detail .mt").removeClass("nav-fixed"), $("#product-detail .mt").removeClass("nav-fixed").floatNav({
            fixedClass: "nav-fixed", targetEle: "#consult", anchor: "#product-detail", range: 30, onStart: function () {
                $("#nav-minicart").show()
            }, onEnd: function () {
                r()
            }
    ...
    if ($('#product-detail [data-widget="tab-item"]').find("a").addClass("toggle-link"), function () {
        ...
        var e, i, s = $(".detail-content"), a = s.find('[name^="detail-tag-id-"]'), d = [],
            p = $('#product-detail [data-widget="tab-item"]'), m = p.eq(0);
        ...
        }), $("#product-detail").scroller({
            startThrehold: 110, onStart: function () {
                c()
            }, onEnd: function () {
                l()
            }
        ...
        defObj: "#consult", defHeight: 0, fn: function () {
            Consult.getData(0, $("#consult-0"))
        }
    }), mlazyload({
        defObj: "#comments-list", defHeight: 0, fn: function () {
        ...
        defObj: "#discuss", defHeight: 0, fn: function () {
            Discuss.getData(0, $("#discuss-1"))
        }
    }), mlazyload({
        defObj: "#comments", defHeight: 0, fn: function () {
            if (!CommentListNew.loadFirstPage) {
                var t = pageConfig.product.isFlashPurchase ? 2 : isAreaProduct ? 1 : 0;
                CommentListNew.getData($("#comment-0"), 0, 0, t)
            }
        ...
        defObj: "#product-track", defHeight: 100, fn: function () {
            $.ajax({
                url: "http://misc.360buyimg.com/product/js/2012/footprint.js?ver=20140724",
                dataType: "script",
                cache: !0
            })
        }
    }), mlazyload({
        defObj: "#product-detail", defHeight: 0, fn: function () {
            Repository.init(G.sku)
        }
    }), mlazyload({
        defObj: "#ranklist", defHeight: 0, fn: function () {
            var t = [], e = $("#ranklist");
    ...
    }), $("#comments-list .tab").append('<li class="tab-last"></li>'), renew(), /from=email/.test(location.href) && $.ajax({
        url: "http://misc.360buyimg.com/product/js/2012/notify.js",
        dataType: "script",
        cache: !0,
        success: function () {
...
//                }
    ...
    if (setImButton(G.sku), 1319 === G.cat[0] && $.ajax({
        url: "http://misc.360buyimg.com/product/js/2012/item.baby.js?ver=20140123",
        cache: !0,
        dataType: "script",
...
var geminiCustomizedDot = geminiCustomizedDot || [], MBuy = {
    init: function () {
