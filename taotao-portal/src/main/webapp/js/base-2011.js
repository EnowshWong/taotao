...
function search(a) {
    var b = "http://search.jd.com/Search?keyword={keyword}&enc={enc}{additional}", c = search.additinal || "",
        d = document.getElementById(a), e = d.value;
    ...
    var g = "&cid{level}={cid}", h = "string" == typeof search.cid ? search.cid : "",
...
function compare() {
    if (null == $("#compare").get(0) && ($("body").prepend('<div id="compare" class="compare"><div class="mt"><h5>\u5546\u54c1\u6bd4\u8f83</h5><div class="extra" onclick="clearCompare()"></div></div><div class="comPro"><ul class="mc" id="comProlist"></ul><div class="mb"><input type="button" value="\u5bf9\u6bd4\u6240\u9009\u5546\u54c1" class="btn" id="compareImg" onclick="openCompare()"></div></div></div>'), $("#compare").css({
        position: "absolute",
        top: "160px",
        right: "0px",
        zIndex: "1"
...
function reduceCompare(a) {
    ...
    var b = readCookie("compare"), c = b.indexOf(a), d = b.indexOf("|||", c) + 3, e = b.substring(c, d),
        f = b.replace(e, "");
...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function () {
    ...
    if (0 != a) {
        var b = "\u9650\u91cf,\u6e05\u4ed3,\u9996\u53d1,\u6ee1\u51cf,\u6ee1\u8d60,\u76f4\u964d,\u65b0\u54c1,\u72ec\u5bb6,\u4eba\u6c14,\u70ed\u5356",
            c = b.split(",")[parseInt(a) - 1], d = "<b class='pi{0}'>{1}</b>";
        switch (c.length) {
            case 1:
...
var searchlog = function () {
    var a = "http://sstat." + pageConfig.FN_getDomain() + "/scslog?args=",
        b = "{keyword}^#psort#^#page#^#cid#^" + encodeURIComponent(document.referrer), c = "2", d = "", e = "",
        f = function () {
            var f = "", g = "", h = "", i = "0";
...
if (function (a) {
    ...
    a.fn.jdTab = function (b, c) {
        ...
        var d = a.extend({
            ...
            subTimer: null,
            index: 0
        }, b || {}), e = a(this).find(d.tab).eq(0).find(d.itemTag), f = a(this).find(d.content);
        if (e.length != f.length)
            return !1;
        var g = d.source.toLowerCase().match(/http:\/\/|\d|\.aspx|\.ascx|\.asp|\.php|\.html\.htm|.shtml|.js|\W/g),
            h = function (a, b) {
    ...
    a.fn.jdSlide = function (b) {
        var c, d, e, f = a.extend({
            ...
            delay1: 100,
            delay2: 5e3
        }, b || {}), g = this, h = 0, i = !0, j = !0, k = f.pics.length, l = function () {
        ...
        var m = function () {
            ...
            var e = parseInt(h), l = Math.abs(e + f.index * f.height), m = Math.abs(a - f.index) * f.height,
                p = Math.ceil((m - l) / 4);
...
pannel.gotop = {
    settings: {element: null, target: "#header"}, init: function (a, b) {
        var c = this;
        ...
        var b, c, d = $(this.settings.element), e = $(this.settings.target),
            f = $.browser.scroll().top + $.browser.client().height - d.height() - 10 + "px";
        switch (a) {
            case 0:
                c = e.width() >= 1200 ? 1200 : 980, b = e.offset().left + c + "px", $.browser.isIE6 ? d.css({
                    left: b,
                    top: f
                }) : d.css({left: b, bottom: "0"});
                break;
            case 1:
...
callback1 = function () {
    ...
    var e = ("https:" == document.location.protocol ? "https://mercuryssl" : "http://mercury") + ".jd.com/log.gif" + "?t=other.000000" + "&m=UA-J2011-1" + "&v=" + encodeURIComponent("t1=" + a + "$t2=" + b + "$p0=" + c) + "&ref=" + encodeURIComponent(document.referrer) + "&rm=" + (new Date).getTime(),
        f = new Image(1, 1);
    f.src = e
}, mark = function (a, b) {
    log(1, b, a)
