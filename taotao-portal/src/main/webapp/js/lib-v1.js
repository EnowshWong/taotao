...
function clothingAbTest() {
    if ("home" == pageConfig.navId) {
        ...
        if (a) {
            var b = getHashProbability(a, 1e4), c = $("#_JD_ALLSORT div.fore6"), d = c.find(".subitem .fore1 dt a"),
                e = c.find(".subitem .fore2 dt a");
...
!function () {
    ...
    var b = a.separator || "&", c = a.spaces === !1 ? !1 : !0,
        d = (a.suffix === !1 ? "" : "[]", a.prefix === !1 ? !1 : !0), e = d ? a.hash === !0 ? "#" : "?" : "",
        f = a.numbers === !1 ? !1 : !0;
    jQuery.query = new function () {
        ...
        return h.prototype = {
            queryObject: !0, has: function (b, c) {
                var d = this.get(b);
                return a(d, c)
            }, GET: function (b) {
                if (!a(b))
    ...
    $.jmsajax = function (a) {
        var b = {
            type: "POST", dataType: "msjson", data: {}, beforeSend: function (a) {
...
!function () {
    ...
    TrimPath.parseTemplate_etc = {}, TrimPath.parseTemplate_etc.statementTag = "forelse|for|if|elseif|else|var|macro", TrimPath.parseTemplate_etc.statementDef = {
        ...
        "/if": {delta: -1, prefix: "}"},
        "for": {
            delta: 1, paramMin: 3, prefixFunc: function (a, b, c, d) {
                if ("in" != a[2])
    ...
    a.fn.Jdropdown = function (b, c) {
        if (this.length) {
            ...
            var d = a.extend({event: "mouseover", current: "hover", delay: 0}, b || {}),
    ...
    a.fn.dropdown = function (b, c) {
        ...
        a.each(this, function () {
            function d() {
                ...
                var b = g.offset(), c = {x: b.left, y: b.top}, d = {x: b.left + g.outerWidth(), y: c.y},
                    e = {x: b.left, y: b.top + g.outerHeight()}, f = {x: b.left + g.outerWidth(), y: e.y};
    ...
    a.fn.Jtab = function (b, c) {
        if (this.length) {
            ...
            var d = a.extend({
                    ...
                    index: 0,
                    compatible: !1
                }, b || {}), e = a(this).find("*[" + d.hookKey + "=" + d.hookItemVal + "]"),
                f = a(this).find("*[" + d.hookKey + "=" + d.hookContentVal + "]"),
                g = d.source.toLowerCase().match(/http:\/\/|\d|\.aspx|\.ascx|\.asp|\.php|\.html\.htm|.shtml|.js/g);
        ...
        if (this.length) {
            var d, e, f = a.extend({
                ...
                var a = document.documentElement, b = document.body,
                    ...
                    d = window.pageYOffset ? window.pageYOffset : a.scrollTop || b.scrollTop, e = a.clientWidth,
                    f = a.clientHeight;
    ...
    a.Jtimer = function (b, c) {
        var d = a.extend({
            ...
            if (c != {} && c && c.start && c.end) {
                var g, h, i, j = e(c.start), k = e(c.server), l = e(c.end), m = (j - k) / 1e3, n = (l - k) / 1e3,
                    o = "#" + d.mainPlaceholder + b, p = "#" + d.subPlaceholder + c.qid,
                    q = "#" + d.resetPlaceholder + c.qid;
                if (0 >= m) {
    ...
    a.fn.Jslider = function (b, c) {
        if (this.length) {
            ...
            var d = a.extend({
                ...
                template: null,
                showControls: !0
            }, b || {}), e = a(this), f = null, g = null, h = null, i = null, j = null, k = function () {
                var a;
                ...
                if (3 == d.slideDirection) {
                    ...
                    1 == d.slideDirection ? (f.css({width: d.slideWidth * d.data.length}), c = -d.slideWidth * b) : e = -d.slideHeight * b, f.animate({
                        top: e + "px",
                        left: c + "px"
                    }, d.speed, function () {
                        d.defaultIndex = b
    ...
    return b = jQuery.extend({
        ...
        function d() {
            var a = Math.ceil(b.num_display_entries / 2), d = c(), e = d - b.num_display_entries,
    ...
    a.extend(a.browser, {
        client: function () {
            ...
            var a = document.documentElement.scrollTop, b = document.body.scrollTop,
                c = document.documentElement.scrollLeft, d = document.body.scrollLeft, e = a ? a : b, f = c ? c : d;
            return {
    ...
    a.fn.jdPosition = function (b) {
        ...
        switch (c.mode) {
            ...
            case "center":
                ...
                a(this).css({
                    left: a.browser.scroll().left + Math.max((a.browser.client().width - d) / 2, 0) + "px",
                    top: a.browser.isIE6 ? a.browser.scroll().top <= a.browser.client().bodyHeight - e ? a.browser.scroll().top + Math.max((a.browser.client().height - e) / 2, 0) + "px" : (a.browser.client().height - e) / 2 + "px" : f ? a.browser.scroll().top : a.browser.scroll().top + Math.max((a.browser.client().height - e) / 2, 0) + "px"
                });
                break;
            case "auto":
                break;
    ...
    a.fn.jdThickBox = function (b, c) {
        ...
        var d, e = a.extend({
            ...
            _thickPadding: 10,
            _wrapBorder: 1
        }, b || {}), f = "function" != typeof this ? a(this) : null, g = function () {
        ...
        var h = function (a) {
            ...
            if (a(".thickcon").css({
                width: e.width,
                height: e.height,
                paddingLeft: e._thickPadding,
                paddingRight: e._thickPadding
            }), setTimeout(function () {
                a(".thickbox").css({
                    width: b + 2 * e._wrapBorder,
                    height: parseInt(e._titleOn ? a(".thicktitle").outerHeight() : 0) + parseInt(a(".thickcon").outerHeight()) + 2 * e._wrapBorder
                })
    ...
    a.fn.jdMarquee = function (b, c) {
        ...
        }, b || {}), f = this.find(e.dom[1]), g = this.find(e.dom[2]);
        ...
        var k = function () {
            ...
            switch (f.css({
                ...
                case "up":
                    ...
                    break;
                case "down":
                    f.css({marginLeft: 0, marginTop: 0}), d.css({
                        marginLeft: 0,
                        marginTop: -h + "px"
                    }), e.pos.clone = -h;
                    break;
            ...
            var b = "up" == e.deriction || "down" == e.deriction ? parseInt(f.get(0).style.marginTop) : parseInt(f.get(0).style.marginLeft),
                ...
                g = Math.max(Math.abs(b - e.pos.object), Math.abs(c - e.pos.clone)), k = Math.ceil((i - g) / e.speed);
            switch (e.deriction) {
                case "up":
    ...
    a = $.extend({
        ...
        complete: null,
        modal: !1
    }, a || {}), "" != a.loginService && "" != a.loginMethod && $.getJSON(a.loginService, {method: a.loginMethod}, function (b) {
    ...
    a.jdCalcul = function (b) {
        var c = null, b = b.join(","), d = "http://qiang.jd.com/HomePageNewLimitBuy.ashx?callback=?&ids=" + b,
            e = "http://item.jd.com/", f = function (b) {
                ...
                if (!(b == {} || "" == b || null == c.start || "" == c.start || null == c.end || "" == c.end || c.pros.length < 1)) {
                    ...
                    var d, f, h, i, j = (c.start - c.server) / 1e3, k = (c.end - c.server) / 1e3, l = function () {
                        var b = '<li><div class="p-img"><a href="{6}{0}.html" target="_blank"><img src="{1}" width="100" height="100" /></a>{2}</div><div class="p-name"><a href="{6}{0}.html" target="_blank">{3}</a></div><div class="p-price">\u62a2\u8d2d\u4ef7\uff1a<strong>{4}</strong>{5}</div></li>',
                            d = "<ul>";
                        a.each(c.pros, function (a) {
                            var f = c.pros[a].id, g = c.pros[a].tp, h = "<div class='pi9'></div>",
                                i = unescape(c.pros[a].mc), j = c.pros[a].qg, k = "(" + c.pros[a].zk + "\u6298)";
        ...
        a.ajax({
            url: d, dataType: "jsonp", success: function (b) {
...
var jdModelCallCenter = {
    settings: {clstag1: 0, clstag2: 0}, tbClose: function () {
        ...
        this.tbClose();
        var a = this, b = navigator.userAgent.toLowerCase(),
        ...
        return c ? (location.href = "https://passport." + pageConfig.FN_getDomain() + "/new/login.aspx?ReturnUrl=" + escape(location.href), void 0) : (setTimeout(function () {
            $.jdThickBox({
                type: "iframe",
                title: "\u60a8\u5c1a\u672a\u767b\u5f55",
                source: "http://passport.jd.com/uc/popupLogin2013?clstag1=" + a.settings.clstag1 + "&clstag2=" + a.settings.clstag2 + "&r=" + Math.random(),
                width: 390,
                height: 450,
                _title: "thicktitler",
                _close: "thickcloser",
...
$.extend(jdModelCallCenter, {
    ...
    $.extend(jdModelCallCenter.settings, {
        clstag1: "login|keycount|5|3", clstag2: "login|keycount|5|4", id: b, fn: function () {
...
var category = {
    ...
    FN_SetLink: function (a) {
        var b = "", c = pageConfig.isHome ? 'clstag="homepage|keycount|home2013|0604e"' : "",
            d = pageConfig.isHome ? 'clstag="homepage|keycount|home2013|0603e"' : "",
            e = pageConfig.isHome ? 'clstag="homepage|keycount|home2013|0605e"' : "";
        switch (a) {
            case "c":
    ...
    getDataService: function (a) {
        ...
        $("#_JD_ALLSORT").dropdown({
            ...
            var b, c, g = document.documentElement.scrollTop + document.body.scrollTop,
                h = $("#nav-2013").offset().top + 39;
    ...
    TPL_Regist: '<div class="prompt">                <span class="fl"><strong>${Name}</strong></span>                <span class="fr"><a href="http://home.jd.com/">\u53bb\u6211\u7684\u4eac\u4e1c\u9996\u9875&nbsp;&gt;</a></span>            </div>',
    TPL_OList: {
    ...
    FN_InitOList: function () {
        $.ajax({
            url: "http://minijd.360buy.com/getOrderList", dataType: "jsonp", success: function (a) {
            ...
            url: "http://minijd.360buy.com/getHomeCount", dataType: "jsonp", success: function (a) {
    ...
    FN_BindEvents: function () {
        ...
        $("#settleup-content .delete").bind("click", function () {
            ...
            b && (b.length > 1 && b[1] && (d.targetId = b[1]), $.ajax({
                url: MCART.URL_Serv, data: d, dataType: "jsonp", success: function (b) {
    ...
    FN_Refresh: function () {
        var a = document.getElementById("settleup") ? $("#settleup dl") : $("#settleup-2013 dl"),
            b = a.find("dd").eq(0), c = function (a) {
                var c = a.Cart,
                    d = c.TheSkus.length + c.TheSuit.length + c.TheGifts.length + c.ManJian.length + c.ManZeng.length,
                    e = MCART.TPL_List.sigle.process(a.Cart), f = MCART.TPL_List.gift.process(a.Cart),
                    g = MCART.TPL_List.suit.process(a.Cart), h = MCART.TPL_List.mz.process(a.Cart),
                    i = MCART.TPL_List.mj.process(a.Cart);
        ...
        $.ajax({
            url: MCART.URL_Serv, data: {method: "GetCart"}, dataType: "jsonp", success: function (a) {
                c(a)
            }
    ...
    init: function (a) {
        var b, c = this, d = this.serializeUrl(location.href),
    ...
    serializeUrl: function (a) {
        var b, c, d, e, f = a.indexOf("?"), g = a.substr(0, f), h = a.substr(f + 1), i = h.split("&"), j = i.length,
            k = {};
        for (b = 0; j > b; b++)
    ...
    setThickBox: function (a, b) {
        var c, d, e, f = {skuId: this.sku, pin: this._userPin, webSite: 1, origin: 1, source: 1},
            g = this.serializeUrl(location.href);
        /blogPin/.test(location.href) && (f.blogPin = g.param.blogPin), 1 == a && (c = "\u964d\u4ef7\u901a\u77e5", d = this._saleNotify, e = 250), 2 == a && (c = "\u5230\u8d27\u901a\u77e5", d = this._stockNotify, e = 210, f.storeAddressId = readCookie("ipLoc-djd") || "0-0-0"), d += b ? b : $.param(f), $.jdThickBox({
            type: "iframe",
            source: decodeURIComponent(d) + "&nocache=" + +new Date,
            width: 500,
            height: e,
            title: c,
            _box: "notify_box",
...
!function () {
    pageConfig.FN_ImgError(document), $("img[data-lazyload]").Jlazyload({
        type: "image",
        placeholderClass: "err-product"
    }), category.FN_Init(), document.getElementById("shortcut") ? $("#shortcut .menu").Jdropdown({delay: 50}) : ($("#biz-service").Jdropdown({delay: 50}, function () {
        $.ajax({
...
//    }));
    ...
    a.find("dl").Jdropdown({delay: 100}, function (a) {
        a.attr("load") || $.login({
            automatic: !1, complete: function (b) {
                if (b) {
...
pageConfig.FN_InitSidebar = function () {
    ...
    var a = a || "_contrast", c = c || "list",
        b = b || "http://misc.360buyimg.com/contrast/js/contrast.js?ver=" + +new Date, d = readCookie(a + "_status");
